...
export default function Programmers() {
  ...
  const getNameOfFeatured = () => {
    ...
    // for (let index = 0; index < programmersList.length; index++) {
    //   if (programmersList[i].id === featuredProgrammer) {
    //     return programmersList[i].name;
    //   }
      
    // }
    // const id = featuredProgrammer - 1;
    // const name = programmersList[id].name;
    // return name;

   return programmersList[featuredProgrammer].name;
